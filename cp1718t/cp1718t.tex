...
\\[\blanklineskip]%
\>[B]{}\Varid{outlineQTree}\;\Varid{f}\;\Varid{q}\mathrel{=}\Varid{qt2bm}\;(\mathsf{fmap}\;\Varid{f}\;\Varid{q}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
&
  \ensuremath{\Conid{Cell}\mathbin{+}(\Conid{QTree}\;\Varid{a}\times(\Conid{QTree}\;\Varid{a}\times(\Conid{QTree}\;\Varid{a}\times\Conid{QTree}\;\Varid{a})))}
...
&
  \ensuremath{\Conid{Matrix}\;\Varid{a}}
    \ar[r]_-{\ensuremath{\Varid{scaleQTree}}}
&
  \ensuremath{\Conid{Matrix}\;\Varid{a}}
