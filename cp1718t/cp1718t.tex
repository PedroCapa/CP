...
\\
\>[B]{}\Varid{outBlockchain}\;(\Conid{Bc}\;\Varid{x})\mathrel{=}i_1\;\Varid{x}{}\<[E]%
\\
...
&
  \ensuremath{\Conid{Block}\mathbin{+}\Conid{Block}\times\Conid{Transactions}}
    \ar[l]_-{\ensuremath{\Varid{trans}}}
}
\end{eqnarray*}
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{allTransactions}\;\Varid{b}\mathrel{=}\Varid{cataBlockchain}\;\Varid{trans}\;\Varid{b}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{trans}\mathbin{::}\Conid{Block}+(\Conid{Block},\Conid{Transactions})\to \Conid{Transactions}{}\<[E]%
\\
\>[B]{}\Varid{trans}\;(i_1\;(\Varid{a},(\Varid{b},\Varid{c})))\mathrel{=}\Varid{c}{}\<[E]%
\\
\>[B]{}\Varid{trans}\;(i_2\;((\Varid{a},(\Varid{b},\Varid{c})),\Varid{x}))\mathrel{=}\mathsf{conc}\;(\Varid{c},\Varid{x}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{ledger}\;\Varid{b}\mathrel{=}\Varid{cataBlockchain}\;\Varid{entityValue}\;\Varid{b}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{entityValue}\mathbin{::}\Conid{Block}+(\Conid{Block},\Conid{Ledger})\to \Conid{Ledger}{}\<[E]%
\\
\>[B]{}\Varid{entityValue}\;(i_1\;(\Varid{a},(\Varid{b},\Varid{c})))\mathrel{=}\Varid{entityLadger}\;\Varid{c}{}\<[E]%
\\
\>[B]{}\Varid{entityValue}\;(i_2\;((\Varid{a},(\Varid{b},\Varid{c})),\Varid{x}))\mathrel{=}\Varid{colocaLedger}\;(\Varid{entityLadger}\;\Varid{c},\Varid{x}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{entityLadger}\mathbin{::}\Conid{Transactions}\to \Conid{Ledger}{}\<[E]%
\\
\>[B]{}\Varid{entityLadger}\;\Varid{l}\mathrel{=}\Varid{cataList}\;\Varid{insereLedger}\;\Varid{l}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{insereLedger}\mathbin{::}()+(\Conid{Transaction},\Conid{Ledger})\to \Conid{Ledger}{}\<[E]%
\\
\>[B]{}\Varid{insereLedger}\;(i_1\;())\mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{insereLedger}\;(i_2\;((\Varid{e},(\Varid{v},\Varid{en})),\Varid{t}))\mathrel{=}\Varid{cons}\;((\Varid{en},\Varid{v}),\Varid{cons}\;((\Varid{e},\Varid{v}),\Varid{t})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{colocaLedger}\mathbin{::}(\Conid{Ledger},\Conid{Ledger})\to \Conid{Ledger}{}\<[E]%
\\
\>[B]{}\Varid{colocaLedger}\;([\mskip1.5mu \mskip1.5mu],\Varid{l})\mathrel{=}\Varid{l}{}\<[E]%
\\
\>[B]{}\Varid{colocaLedger}\;((\Varid{h}\mathbin{:}\Varid{t}),\Varid{l})\mathrel{=}\Varid{colocaNodo}\;\Varid{h}\;(\Varid{colocaLedger}\;(\Varid{t},\Varid{l})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{colocaNodo}\mathbin{::}(\Conid{Entity},\Conid{Value})\to \Conid{Ledger}\to \Conid{Ledger}{}\<[E]%
\\
\>[B]{}\Varid{colocaNodo}\;\Varid{n}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}\Varid{singl}\;\Varid{n}{}\<[E]%
\\
\>[B]{}\Varid{colocaNodo}\;(\Varid{x},\Varid{y})\;((\Varid{a},\Varid{b})\mathbin{:}\Varid{t})\mathrel{=}\mathbf{if}\;(\Varid{x}\equiv \Varid{a})\;\mathbf{then}\;\Varid{cons}\;((\Varid{a},\Varid{b}\mathbin{+}\Varid{y}),\Varid{t})\;\mathbf{else}\;\Varid{cons}\;((\Varid{a},\Varid{b}),\Varid{colocaNodo}\;(\Varid{x},\Varid{y})\;\Varid{t}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
&
  \ensuremath{\Conid{Block}\mathbin{+}\Conid{Block}\times\Conid{Blockchain}}
    ...
    \ar[l]_-{outBlockchain}
\\
  \ensuremath{\Conid{MagicNr}\mathbin{*}}
&
  \ensuremath{\Conid{Block}\mathbin{+}\Conid{Block}\times\Conid{MagicNr}\mathbin{*}}
    \ar[l]_-{\ensuremath{\Varid{block2List}}}
}
\end{eqnarray*}
...
\xymatrix@C=2cm{
  \ensuremath{\Conid{Blockchain}}
    \ar[r]_-{\ensuremath{\Varid{block2List}}}
    \ar[d]_-{\ensuremath{\Varid{isValidMagicNr}}}
&
  \ensuremath{\Conid{MagicNr}\mathbin{*}}
    \ar[d]_-{\ensuremath{\Varid{verifica}}}
\\
  \ensuremath{\Conid{Bool}}
&
  \ensuremath{\Conid{MagicNr}\mathbin{*}\times\Conid{Bool}}
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{isValidMagicNr}\;\Varid{b}\mathrel{=}\p2\;(\Varid{cataList}\;\Varid{verifica}\;(\Varid{cataBlockchain}\;\Varid{block2List}\;\Varid{b})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{block2List}\mathbin{::}\Conid{Block}+(\Conid{Block},[\mskip1.5mu \Conid{MagicNo}\mskip1.5mu])\to [\mskip1.5mu \Conid{MagicNo}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{block2List}\;(i_1\;(\Varid{a},(\Varid{b},\Varid{c})))\mathrel{=}\Varid{singl}\;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{block2List}\;(i_2\;((\Varid{a},(\Varid{b},\Varid{c})),\Varid{d}))\mathrel{=}\Varid{cons}\;(\Varid{a},\Varid{d}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{verifica}\mathbin{::}()+(\Conid{MagicNo},([\mskip1.5mu \Conid{MagicNo}\mskip1.5mu],\Conid{Bool}))\to ([\mskip1.5mu \Conid{MagicNo}\mskip1.5mu],\Conid{Bool}){}\<[E]%
\\
\>[B]{}\Varid{verifica}\;(i_1\;())\mathrel{=}([\mskip1.5mu \mskip1.5mu],\Conid{True}){}\<[E]%
\\
\>[B]{}\Varid{verifica}\;(i_2\;(\Varid{val},(\Varid{l},\Varid{b})))\mathrel{=}(\Varid{cons}\;(\Varid{val},\Varid{l}),(\neg \;(\Varid{elem}\;\Varid{val}\;\Varid{l}))\mathrel{\wedge}\Varid{b}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{outQTree}\;(\Conid{Cell}\;\Varid{n}\;\Varid{c}\;\Varid{l}){}\<[26]%
\>[26]{}\mathrel{=}i_1\;(\Varid{n},(\Varid{c},\Varid{l})){}\<[E]%
\\
\>[B]{}\Varid{outQTree}\;(\Conid{Block}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{d})\mathrel{=}i_2\;(\Varid{a},(\Varid{b},(\Varid{c},\Varid{d}))){}\<[E]%
\\
\>[B]{}\Varid{baseQTree}\;\Varid{g}\;\Varid{f}\mathrel{=}(\Varid{baseQTreefst}\;\Varid{g})+(\Varid{f}\times(\Varid{f}\times(\Varid{f}\times\Varid{f}))){}\<[E]%
\\
...
\xymatrix@C=5cm{
  \ensuremath{\Conid{QTree}\;\Varid{a}}
    \ar[r]_-{\ensuremath{\Varid{inQTree}}}
    \ar[d]_-{\ensuremath{\Varid{rotateQTree}}}
&
  \ensuremath{\Conid{Cell}\;\Varid{a}\mathbin{+}(\Conid{QTree}\;\Varid{a}\times(\Conid{QTree}\;\Varid{a}\times(\Conid{QTree}\;\Varid{a}\times\Conid{QTree}\;\Varid{a})))}
    \ar[d]_-{\ensuremath{\Varid{id}\mathbin{+}(\Varid{rotateQTree}\times(\Varid{rotateQTree}\times(\Varid{rotateQTree}\times\Varid{rotateQTree})))}}
    \ar[l]_-{\ensuremath{\Varid{outQTree}}}
\\
  \ensuremath{\Conid{QTree}\;\Varid{a}}
&
  \ensuremath{\Conid{Cell}\;\Varid{a}\mathbin{+}(\Conid{QTree}\;\Varid{a}\times(\Conid{QTree}\;\Varid{a}\times(\Conid{QTree}\;\Varid{a}\times\Conid{QTree}\;\Varid{a})))}
    \ar[l]_-{\ensuremath{\Varid{rotate90}}}
}
\end{eqnarray*}
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{rotateQTree}\;\Varid{q}\mathrel{=}\Varid{cataQTree}\;\Varid{rotate90}\;\Varid{q}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{rotate90}\mathbin{::}(\Varid{a},(\Conid{Int},\Conid{Int}))+(\Conid{QTree}\;\Varid{a},(\Conid{QTree}\;\Varid{a},(\Conid{QTree}\;\Varid{a},\Conid{QTree}\;\Varid{a})))\to \Conid{QTree}\;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{rotate90}\;(i_1\;(\Varid{n},(\Varid{x},\Varid{y})))\mathrel{=}\Conid{Cell}\;\Varid{n}\;\Varid{y}\;\Varid{x}{}\<[E]%
\\
\>[B]{}\Varid{rotate90}\;(i_2\;(\Varid{a},(\Varid{b},(\Varid{c},\Varid{d}))))\mathrel{=}\Conid{Block}\;\Varid{c}\;\Varid{a}\;\Varid{d}\;\Varid{b}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
&
  \ensuremath{\Conid{Cell}\;\Varid{a}\mathbin{+}(\Conid{QTree}\;\Varid{a}\times(\Conid{QTree}\;\Varid{a}\times(\Conid{QTree}\;\Varid{a}\times\Conid{QTree}\;\Varid{a})))}
    \ar[d]_-{\ensuremath{\Varid{id}\mathbin{+}(\Varid{scaleQTree}\times(\Varid{scaleQTree}\times(\Varid{scaleQTree}\times\Varid{scaleQTree})))}}
    \ar[l]_-{\ensuremath{\Varid{outQTree}}}
\\
  \ensuremath{\Conid{QTree}\;\Varid{a}}
&
  \ensuremath{\Conid{Cell}\;\Varid{a}\mathbin{+}(\Conid{QTree}\;\Varid{a}\times(\Conid{QTree}\;\Varid{a}\times(\Conid{QTree}\;\Varid{a}\times\Conid{QTree}\;\Varid{a})))}
    \ar[l]_-{\ensuremath{\Varid{amplia}}}
}
\end{eqnarray*}
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{scaleQTree}\;\Varid{i}\;\Varid{q}\mathrel{=}\Varid{cataQTree}\;(\Varid{amplia}\;\Varid{i})\;\Varid{q}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{amplia}\mathbin{::}\Conid{Int}\to (\Varid{a},(\Conid{Int},\Conid{Int}))+(\Conid{QTree}\;\Varid{a},(\Conid{QTree}\;\Varid{a},(\Conid{QTree}\;\Varid{a},\Conid{QTree}\;\Varid{a})))\to \Conid{QTree}\;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{amplia}\;\Varid{i}\;(i_1\;(\Varid{n},(\Varid{x},\Varid{y})))\mathrel{=}(\Conid{Cell}\;\Varid{n}\;(\Varid{x}\mathbin{*}\Varid{i})\;(\Varid{y}\mathbin{*}\Varid{i})){}\<[E]%
\\
\>[B]{}\Varid{amplia}\;\Varid{i}\;(i_2\;(\Varid{a},(\Varid{b},(\Varid{c},\Varid{d}))))\mathrel{=}(\Conid{Block}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{d}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\xymatrix@C=2cm{
  \ensuremath{\Conid{QTree}\;\Varid{a}}
    \ar[r]_-{\ensuremath{\Varid{qt2bm}}}
&
  \ensuremath{\Conid{Matrix}\;\Varid{a}}
    \ar[r]_-{\ensuremath{\Varid{inverte}}}
&
  \ensuremath{\Conid{Matrix}\;\Varid{a}}
    \ar[r]_-{\ensuremath{\Varid{bm2qt}}}
&
  \ensuremath{\Conid{QTree}\;\Varid{a}}
}
\end{eqnarray*}
...
&
  \ensuremath{\Conid{Cell}\;\Varid{a}\mathbin{+}(\Conid{QTree}\;\Varid{a}\times(\Conid{QTree}\;\Varid{a}\times(\Conid{QTree}\;\Varid{a}\times\Conid{QTree}\;\Varid{a})))}
    \ar[l]_-{\ensuremath{\Varid{inverte}}}
}
\end{eqnarray*}
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{invertQTree}\;\Varid{q}\mathrel{=}\Varid{bm2qt}\;(\Varid{inverte}\;(\Varid{qt2bm}\;\Varid{q})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{inverte}\mathbin{::}\Conid{Matrix}\;\Conid{PixelRGBA8}\to \Conid{Matrix}\;\Conid{PixelRGBA8}{}\<[E]%
\\
\>[B]{}\Varid{inverte}\;\Varid{m}\mathrel{=}(\Varid{fromList}\;(\Varid{nrows}\;\Varid{m})\;(\Varid{ncols}\;\Varid{m})\;(\Varid{cataList}\;(\Varid{inverteLista})\;(\Varid{toList}\;\Varid{m}))){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{inverteLista}\mathbin{::}()+(\Conid{PixelRGBA8},[\mskip1.5mu \Conid{PixelRGBA8}\mskip1.5mu])\to [\mskip1.5mu \Conid{PixelRGBA8}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{inverteLista}\;(i_1\;\Varid{nil})\mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{inverteLista}\;(i_2\;(\Conid{PixelRGBA8}\;\Varid{r}\;\Varid{g}\;\Varid{b}\;\Varid{a},\Varid{xs}))\mathrel{=}\Conid{PixelRGBA8}\;(\mathrm{255}\mathbin{-}\Varid{r})\;(\mathrm{255}\mathbin{-}\Varid{g})\;(\mathrm{255}\mathbin{-}\Varid{b})\;\Varid{a}\mathbin{:}\Varid{xs}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{compressQTree}\;\Varid{c}\;\Varid{q}\mathrel{=}\Varid{anaQTree}\;\Varid{comprimeAna}\;((\Varid{depthQTree}\;\Varid{q})\mathbin{-}\Varid{c},\Varid{q}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{comprimeAna}\mathbin{::}(\Conid{Int},\Conid{QTree}\;\Varid{a})\to (\Varid{a},(\Conid{Int},\Conid{Int}))+((\Conid{Int},\Conid{QTree}\;\Varid{a}),((\Conid{Int},\Conid{QTree}\;\Varid{a}),((\Conid{Int},\Conid{QTree}\;\Varid{a}),(\Conid{Int},\Conid{QTree}\;\Varid{a})))){}\<[E]%
\\
\>[B]{}\Varid{comprimeAna}\;(\anonymous ,(\Conid{Cell}\;\Varid{n}\;\Varid{x}\;\Varid{y}))\mathrel{=}i_1\;((\Varid{n},(\Varid{x},\Varid{y}))){}\<[E]%
\\
\>[B]{}\Varid{comprimeAna}\;(\mathrm{0},(\Conid{Block}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{d}))\mathrel{=}i_1\;(\Varid{block2CellAna}\;(\Conid{Block}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{d})){}\<[E]%
\\
\>[B]{}\Varid{comprimeAna}\;(\Varid{alt},(\Conid{Block}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{d}))\mathrel{=}i_2\;((\Varid{n},\Varid{a}),((\Varid{n},\Varid{b}),((\Varid{n},\Varid{c}),((\Varid{n},\Varid{d}))))){}\<[E]%
\\
\>[B]{}\hsindent{11}{}\<[11]%
\>[11]{}\mathbf{where}\;\Varid{n}\mathrel{=}\Varid{pred}\;\Varid{alt}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{block2CellAna}\mathbin{::}\Conid{QTree}\;\Varid{a}\to (\Varid{a},(\Conid{Int},\Conid{Int})){}\<[E]%
\\
\>[B]{}\Varid{block2CellAna}\;(\Conid{Cell}\;\Varid{n}\;\Varid{x}\;\Varid{y})\mathrel{=}(\Varid{n},(\Varid{x},\Varid{y})){}\<[E]%
\\
\>[B]{}\Varid{block2CellAna}\;(\Conid{Block}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{d})\mathrel{=}\Varid{calculaAna}\;(\Varid{block2CellAna}\;\Varid{a})\;(\Varid{block2CellAna}\;\Varid{b})\;(\Varid{block2CellAna}\;\Varid{c})\;(\Varid{block2CellAna}\;\Varid{d}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{calculaAna}\mathbin{::}(\Varid{a},(\Conid{Int},\Conid{Int}))\to (\Varid{a},(\Conid{Int},\Conid{Int}))\to (\Varid{a},(\Conid{Int},\Conid{Int}))\to (\Varid{a},(\Conid{Int},\Conid{Int}))\to (\Varid{a},(\Conid{Int},\Conid{Int})){}\<[E]%
\\
\>[B]{}\Varid{calculaAna}\;(\Varid{a},(\Varid{b},\Varid{c}))\;(\anonymous ,(\Varid{d},\anonymous ))\;(\anonymous ,(\anonymous ,\Varid{e}))\;\anonymous \mathrel{=}(\Varid{a},(\Varid{b}\mathbin{+}\Varid{d},\Varid{c}\mathbin{+}\Varid{e})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\xymatrix@C=3cm{
  \ensuremath{\Conid{QTree}\;\Varid{a}}
    \ar[r]_-{\ensuremath{\Varid{inQTree}}}
    \ar[d]_-{\ensuremath{\Varid{outlineQTree}}}
&
  \ensuremath{\Conid{Cell}\;\Varid{a}\mathbin{+}(\Conid{QTree}\;\Varid{a}\times(\Conid{QTree}\;\Varid{a}\times(\Conid{QTree}\;\Varid{a}\times\Conid{QTree}\;\Varid{a})))}
    \ar[d]_-{\ensuremath{\Varid{id}\mathbin{+}(\Varid{outlineQTree}\times(\Varid{outlineQTree}\times(\Varid{outlineQTree}\times\Varid{outlineQTree})))}}
    \ar[l]_-{\ensuremath{\Varid{outQTree}}}
\\
  \ensuremath{\Conid{QTree}\;\Conid{Bool}}
&
  \ensuremath{\Conid{Cell}\;\Varid{a}\mathbin{+}(\Conid{QTree}\;\Conid{Bool}\times(\Conid{QTree}\;\Conid{Bool}\times(\Conid{QTree}\;\Conid{Bool}\times\Conid{QTree}\;\Conid{Bool})))}
    \ar[l]_-{\ensuremath{\Varid{teste}}}
}
\end{eqnarray*}
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{outlineQTree}\;\Varid{f}\;\Varid{q}\mathrel{=}\Varid{qt2bm}\;(\Varid{cataQTree}\;\Varid{teste}\;(\mathsf{fmap}\;\Varid{f}\;\Varid{q})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{teste}\mathbin{::}(\Conid{Bool},(\Conid{Int},\Conid{Int}))+(\Conid{QTree}\;\Conid{Bool},(\Conid{QTree}\;\Conid{Bool},(\Conid{QTree}\;\Conid{Bool},\Conid{QTree}\;\Conid{Bool})))\to \Conid{QTree}\;\Conid{Bool}{}\<[E]%
\\
\>[B]{}\Varid{teste}\;(i_1\;(\Conid{False},(\Varid{x},\Varid{y})))\mathrel{=}\Conid{Cell}\;\Conid{False}\;\Varid{x}\;\Varid{y}{}\<[E]%
\\
\>[B]{}\Varid{teste}\;(i_1\;(\Conid{True},(\Varid{x},\Varid{y})))\mathrel{=}\mathbf{if}\;(\Varid{divideInicial}\;(\Varid{x},\Varid{y})){}\<[E]%
\\
\>[B]{}\hsindent{31}{}\<[31]%
\>[31]{}\mathbf{then}\;\Conid{Block}\;(\Varid{criaTopoEsq}\;\mathrm{0}\;\Varid{nova})\;(\Varid{criaTopoDir}\;\mathrm{0}\;\Varid{nova})\;(\Varid{criaFundoEsq}\;\mathrm{0}\;\Varid{nova})\;(\Varid{criaFundoDir}\;\mathrm{0}\;\Varid{nova}){}\<[E]%
\\
\>[B]{}\hsindent{31}{}\<[31]%
\>[31]{}\mathbf{else}\;\Conid{Cell}\;\Conid{True}\;\Varid{x}\;\Varid{y}{}\<[E]%
\\
\>[B]{}\hsindent{31}{}\<[31]%
\>[31]{}\mathbf{where}\;\Varid{nova}\mathrel{=}\Conid{Cell}\;\Conid{True}\;\Varid{x}\div \mathrm{2}\;\Varid{y}\div \mathrm{2}{}\<[E]%
\\
\>[B]{}\Varid{teste}\;(i_2\;(\Varid{a},(\Varid{b},(\Varid{c},\Varid{d}))))\mathrel{=}\Conid{Block}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{d}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{criaTopoEsq}\mathbin{::}\Conid{Int}\to \Conid{QTree}\;\Conid{Bool}\to \Conid{QTree}\;\Conid{Bool}{}\<[E]%
\\
\>[B]{}\Varid{criaTopoEsq}\;\mathrm{0}\;(\Conid{Cell}\;\Varid{a}\;\Varid{x}\;\Varid{y})\mathrel{=}\mathbf{if}\;\Varid{divide}\;(\Varid{x},\Varid{y}){}\<[E]%
\\
\>[B]{}\hsindent{28}{}\<[28]%
\>[28]{}\mathbf{then}\;\Conid{Block}\;(\Varid{criaTopoEsq}\;\mathrm{0}\;\Varid{nova})\;(\Varid{criaTopoDir}\;\mathrm{2}\;\Varid{nova})\;(\Varid{criaFundoEsq}\;\mathrm{1}\;\Varid{nova})\;\Varid{new}{}\<[E]%
\\
\>[B]{}\hsindent{28}{}\<[28]%
\>[28]{}\mathbf{else}\;\Conid{Cell}\;\Varid{a}\;\Varid{x}\;\Varid{y}{}\<[E]%
\\
\>[B]{}\hsindent{28}{}\<[28]%
\>[28]{}\mathbf{where}\;\Varid{nova}\mathrel{=}\Conid{Cell}\;\Varid{a}\;\Varid{x}\div \mathrm{2}\;\Varid{y}\div \mathrm{2}{}\<[E]%
\\
\>[28]{}\hsindent{6}{}\<[34]%
\>[34]{}\Varid{new}\mathrel{=}\Conid{Cell}\;(\neg \;\Varid{a})\;{}\<[54]%
\>[54]{}\Varid{x}\div \mathrm{2}\;\Varid{y}\div \mathrm{2}{}\<[E]%
\\
\>[B]{}\Varid{criaTopoEsq}\;\mathrm{1}\;(\Conid{Cell}\;\Varid{a}\;\Varid{x}\;\Varid{y})\mathrel{=}\mathbf{if}\;\Varid{divide}\;(\Varid{x},\Varid{y}){}\<[E]%
\\
\>[B]{}\hsindent{28}{}\<[28]%
\>[28]{}\mathbf{then}\;\Conid{Block}\;(\Varid{criaTopoEsq}\;\mathrm{1}\;\Varid{nova})\;\Varid{new}\;(\Varid{criaFundoEsq}\;\mathrm{1}\;\Varid{nova})\;\Varid{new}{}\<[E]%
\\
\>[B]{}\hsindent{28}{}\<[28]%
\>[28]{}\mathbf{else}\;\Conid{Cell}\;\Varid{a}\;\Varid{x}\;\Varid{y}{}\<[E]%
\\
...
\>[54]{}\Varid{x}\div \mathrm{2}\;\Varid{y}\div \mathrm{2}{}\<[E]%
\\
\>[B]{}\Varid{criaTopoEsq}\;\mathrm{2}\;(\Conid{Cell}\;\Varid{a}\;\Varid{x}\;\Varid{y})\mathrel{=}\mathbf{if}\;\Varid{divide}\;(\Varid{x},\Varid{y}){}\<[E]%
\\
\>[B]{}\hsindent{28}{}\<[28]%
\>[28]{}\mathbf{then}\;\Conid{Block}\;(\Varid{criaTopoEsq}\;\mathrm{2}\;\Varid{nova})\;(\Varid{criaTopoDir}\;\mathrm{2}\;\Varid{nova})\;\Varid{new}\;\Varid{new}{}\<[E]%
\\
\>[B]{}\hsindent{28}{}\<[28]%
\>[28]{}\mathbf{else}\;\Conid{Cell}\;\Varid{a}\;\Varid{x}\;\Varid{y}{}\<[E]%
\\
...
\>[54]{}\Varid{x}\div \mathrm{2}\;\Varid{y}\div \mathrm{2}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{criaTopoDir}\mathbin{::}\Conid{Int}\to {}\<[24]%
\>[24]{}\Conid{QTree}\;\Conid{Bool}\to \Conid{QTree}\;\Conid{Bool}{}\<[E]%
\\
\>[B]{}\Varid{criaTopoDir}\;\mathrm{0}\;(\Conid{Cell}\;\Varid{a}\;\Varid{x}\;\Varid{y})\mathrel{=}\mathbf{if}\;\Varid{divide}\;(\Varid{x},\Varid{y}){}\<[E]%
\\
\>[B]{}\hsindent{28}{}\<[28]%
\>[28]{}\mathbf{then}\;\Conid{Block}\;(\Varid{criaTopoEsq}\;\mathrm{2}\;\Varid{nova})\;(\Varid{criaTopoDir}\;\mathrm{0}\;\Varid{nova})\;\Varid{new}\;(\Varid{criaFundoDir}\;\mathrm{1}\;\Varid{nova}){}\<[E]%
\\
\>[B]{}\hsindent{28}{}\<[28]%
\>[28]{}\mathbf{else}\;\Conid{Cell}\;\Varid{a}\;\Varid{x}\;\Varid{y}{}\<[E]%
\\
...
\>[54]{}\Varid{x}\div \mathrm{2}\;\Varid{y}\div \mathrm{2}{}\<[E]%
\\
\>[B]{}\Varid{criaTopoDir}\;\mathrm{1}\;(\Conid{Cell}\;\Varid{a}\;\Varid{x}\;\Varid{y})\mathrel{=}\mathbf{if}\;\Varid{divide}\;(\Varid{x},\Varid{y}){}\<[E]%
\\
\>[B]{}\hsindent{28}{}\<[28]%
\>[28]{}\mathbf{then}\;\Conid{Block}\;\Varid{new}\;(\Varid{criaTopoDir}\;\mathrm{1}\;\Varid{nova})\;\Varid{new}\;(\Varid{criaFundoDir}\;\mathrm{1}\;\Varid{nova}){}\<[E]%
\\
\>[B]{}\hsindent{28}{}\<[28]%
\>[28]{}\mathbf{else}\;\Conid{Cell}\;\Varid{a}\;\Varid{x}\;\Varid{y}{}\<[E]%
\\
...
\>[54]{}\Varid{x}\div \mathrm{2}\;\Varid{y}\div \mathrm{2}{}\<[E]%
\\
\>[B]{}\Varid{criaTopoDir}\;\mathrm{2}\;(\Conid{Cell}\;\Varid{a}\;\Varid{x}\;\Varid{y})\mathrel{=}\mathbf{if}\;\Varid{divide}\;(\Varid{x},\Varid{y}){}\<[E]%
\\
\>[B]{}\hsindent{28}{}\<[28]%
\>[28]{}\mathbf{then}\;\Conid{Block}\;(\Varid{criaTopoEsq}\;\mathrm{2}\;\Varid{nova})\;(\Varid{criaTopoDir}\;\mathrm{2}\;\Varid{nova})\;\Varid{new}\;\Varid{new}{}\<[E]%
\\
...
\>[54]{}\Varid{x}\div \mathrm{2}\;\Varid{y}\div \mathrm{2}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{criaFundoEsq}\mathbin{::}\Conid{Int}\to \Conid{QTree}\;\Conid{Bool}\to \Conid{QTree}\;\Conid{Bool}{}\<[E]%
\\
\>[B]{}\Varid{criaFundoEsq}\;\mathrm{0}\;(\Conid{Cell}\;\Varid{a}\;\Varid{x}\;\Varid{y})\mathrel{=}\mathbf{if}\;\Varid{divide}\;(\Varid{x},\Varid{y}){}\<[E]%
\\
\>[B]{}\hsindent{28}{}\<[28]%
\>[28]{}\mathbf{then}\;\Conid{Block}\;(\Varid{criaTopoEsq}\;\mathrm{1}\;\Varid{nova})\;\Varid{new}\;(\Varid{criaFundoEsq}\;\mathrm{0}\;\Varid{nova})\;(\Varid{criaFundoDir}\;\mathrm{2}\;\Varid{nova}){}\<[E]%
\\
\>[B]{}\hsindent{28}{}\<[28]%
\>[28]{}\mathbf{else}\;\Conid{Cell}\;\Varid{a}\;\Varid{x}\;\Varid{y}{}\<[E]%
\\
...
\>[54]{}\Varid{x}\div \mathrm{2}\;\Varid{y}\div \mathrm{2}{}\<[E]%
\\
\>[B]{}\Varid{criaFundoEsq}\;\mathrm{1}\;(\Conid{Cell}\;\Varid{a}\;\Varid{x}\;\Varid{y})\mathrel{=}\mathbf{if}\;\Varid{divide}\;(\Varid{x},\Varid{y}){}\<[E]%
\\
\>[B]{}\hsindent{28}{}\<[28]%
\>[28]{}\mathbf{then}\;\Conid{Block}\;(\Varid{criaTopoEsq}\;\mathrm{1}\;\Varid{nova})\;\Varid{new}\;(\Varid{criaFundoEsq}\;\mathrm{1}\;\Varid{nova})\;\Varid{new}{}\<[E]%
\\
...
\>[54]{}\Varid{x}\div \mathrm{2}\;\Varid{y}\div \mathrm{2}{}\<[E]%
\\
\>[B]{}\Varid{criaFundoEsq}\;\mathrm{2}\;(\Conid{Cell}\;\Varid{a}\;\Varid{x}\;\Varid{y})\mathrel{=}\mathbf{if}\;\Varid{divide}\;(\Varid{x},\Varid{y}){}\<[E]%
\\
\>[B]{}\hsindent{28}{}\<[28]%
\>[28]{}\mathbf{then}\;\Conid{Block}\;\Varid{new}\;\Varid{new}\;(\Varid{criaFundoEsq}\;\mathrm{2}\;\Varid{nova})\;(\Varid{criaFundoDir}\;\mathrm{2}\;\Varid{nova}){}\<[E]%
\\
\>[B]{}\hsindent{28}{}\<[28]%
\>[28]{}\mathbf{else}\;\Conid{Cell}\;\Varid{a}\;\Varid{x}\;\Varid{y}{}\<[E]%
\\
...
\>[54]{}\Varid{x}\div \mathrm{2}\;\Varid{y}\div \mathrm{2}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{criaFundoDir}\mathbin{::}\Conid{Int}\to \Conid{QTree}\;\Conid{Bool}\to \Conid{QTree}\;\Conid{Bool}{}\<[E]%
\\
\>[B]{}\Varid{criaFundoDir}\;\mathrm{0}\;(\Conid{Cell}\;\Varid{a}\;\Varid{x}\;\Varid{y})\mathrel{=}\mathbf{if}\;\Varid{divide}\;(\Varid{x},\Varid{y}){}\<[E]%
\\
\>[B]{}\hsindent{28}{}\<[28]%
\>[28]{}\mathbf{then}\;\Conid{Block}\;\Varid{new}\;(\Varid{criaTopoDir}\;\mathrm{1}\;\Varid{nova})\;(\Varid{criaFundoEsq}\;\mathrm{2}\;\Varid{nova})\;(\Varid{criaFundoDir}\;\mathrm{0}\;\Varid{nova}){}\<[E]%
\\
\>[B]{}\hsindent{28}{}\<[28]%
\>[28]{}\mathbf{else}\;\Conid{Cell}\;\Varid{a}\;\Varid{x}\;\Varid{y}{}\<[E]%
\\
...
\>[54]{}\Varid{x}\div \mathrm{2}\;\Varid{y}\div \mathrm{2}{}\<[E]%
\\
\>[B]{}\Varid{criaFundoDir}\;\mathrm{1}\;(\Conid{Cell}\;\Varid{a}\;\Varid{x}\;\Varid{y})\mathrel{=}\mathbf{if}\;\Varid{divide}\;(\Varid{x},\Varid{y}){}\<[E]%
\\
\>[B]{}\hsindent{28}{}\<[28]%
\>[28]{}\mathbf{then}\;\Conid{Block}\;\Varid{new}\;(\Varid{criaTopoDir}\;\mathrm{1}\;\Varid{nova})\;\Varid{new}\;(\Varid{criaFundoDir}\;\mathrm{1}\;\Varid{nova}){}\<[E]%
\\
...
\>[54]{}\Varid{x}\div \mathrm{2}\;\Varid{y}\div \mathrm{2}{}\<[E]%
\\
\>[B]{}\Varid{criaFundoDir}\;\mathrm{2}\;(\Conid{Cell}\;\Varid{a}\;\Varid{x}\;\Varid{y})\mathrel{=}\mathbf{if}\;\Varid{divide}\;(\Varid{x},\Varid{y}){}\<[E]%
\\
\>[B]{}\hsindent{28}{}\<[28]%
\>[28]{}\mathbf{then}\;\Conid{Block}\;\Varid{new}\;\Varid{new}\;(\Varid{criaFundoEsq}\;\mathrm{2}\;\Varid{nova})\;(\Varid{criaFundoDir}\;\mathrm{2}\;\Varid{nova}){}\<[E]%
\\
...
\>[54]{}\Varid{x}\div \mathrm{2}\;\Varid{y}\div \mathrm{2}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{divide}\mathbin{::}(\Conid{Int},\Conid{Int})\to \Conid{Bool}{}\<[E]%
\\
\>[B]{}\Varid{divide}\;(\Varid{x},\Varid{y})\mathrel{=}\Varid{x}\geq \mathrm{2}\mathrel{\wedge}\Varid{y}\geq \mathrm{2}\mathrel{\wedge}\Varid{mod}\;\Varid{x}\;\mathrm{2}\equiv \mathrm{0}\mathrel{\wedge}\Varid{mod}\;\Varid{y}\;\mathrm{2}\equiv \mathrm{0}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{divideInicial}\mathbin{::}(\Conid{Int},\Conid{Int})\to \Conid{Bool}{}\<[E]%
\\
\>[B]{}\Varid{divideInicial}\;(\Varid{x},\Varid{y})\mathrel{=}\Varid{x}\geq \mathrm{4}\mathrel{\wedge}\Varid{y}\geq \mathrm{4}\mathrel{\wedge}\Varid{mod}\;\Varid{x}\;\mathrm{2}\equiv \mathrm{0}\mathrel{\wedge}\Varid{mod}\;\Varid{y}\;\mathrm{2}\equiv \mathrm{0}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{uncurryCell}\mathbin{::}(\Varid{a}\to \Varid{b}\to \Varid{c}\to \Varid{d})\to (\Varid{a},(\Varid{b},\Varid{c}))\to \Varid{d}{}\<[E]%
\\
\>[B]{}\Varid{uncurryCell}\;\Varid{a}\;(\Varid{b},(\Varid{c},\Varid{d}))\mathrel{=}\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{d}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{curryCell}\mathbin{::}((\Varid{a},(\Varid{b},\Varid{c}))\to \Varid{d})\to \Varid{a}\to \Varid{b}\to \Varid{c}\to \Varid{d}{}\<[E]%
\\
\>[B]{}\Varid{curryCell}\;\Varid{d}\;\Varid{a}\;\Varid{b}\;\Varid{c}\mathrel{=}\Varid{d}\;(\Varid{a},(\Varid{b},\Varid{c})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{uncurryBlock}\mathbin{::}(\Varid{a}\to \Varid{b}\to \Varid{c}\to \Varid{d}\to \Varid{e})\to (\Varid{a},(\Varid{b},(\Varid{c},\Varid{d})))\to \Varid{e}{}\<[E]%
\\
\>[B]{}\Varid{uncurryBlock}\;\Varid{a}\;(\Varid{b},(\Varid{c},(\Varid{d},\Varid{e})))\mathrel{=}\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{d}\;\Varid{e}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{curryBlock}\mathbin{::}((\Varid{a},(\Varid{b},(\Varid{c},\Varid{d})))\to \Varid{e})\to \Varid{a}\to \Varid{b}\to \Varid{c}\to \Varid{d}\to \Varid{e}{}\<[E]%
\\
\>[B]{}\Varid{curryBlock}\;\Varid{e}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{d}\mathrel{=}\Varid{e}\;(\Varid{a},(\Varid{b},(\Varid{c},\Varid{d}))){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{baseQTreefst}\mathbin{::}(\Varid{a1}\to \Varid{b})\to (\Varid{a1},\Varid{d2})\to (\Varid{b},\Varid{d2}){}\<[E]%
\\
\>[B]{}\Varid{baseQTreefst}\;\Varid{g}\;(\Varid{a1},\Varid{d2})\mathrel{=}(\Varid{g}\;\Varid{a1},\Varid{d2}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{base}\mathrel{=}\Varid{convtuplo}\comp \conj{\conj{\underline{\mathrm{1}}}{\succ }}{\conj{\underline{\mathrm{1}}}{\underline{\mathrm{1}}}}{}\<[E]%
\\
\>[B]{}\Varid{loop}\mathrel{=}\Varid{convtuplo}\comp \conj{\conj{\Varid{mul}\comp \p1}{\succ \comp \p2\comp \p1}}{\conj{\Varid{mul}\comp \p2}{\succ \comp \p2\comp \p2}}\comp \Varid{invConvTuplo}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{convtuplo}\mathbin{::}((\Conid{Integer},\Conid{Integer}),(\Conid{Integer},\Conid{Integer}))\to (\Conid{Integer},\Conid{Integer},\Conid{Integer},\Conid{Integer}){}\<[E]%
\\
\>[B]{}\Varid{convtuplo}\;((\Varid{x},\Varid{y}),(\Varid{w},\Varid{z}))\mathrel{=}(\Varid{x},\Varid{y},\Varid{w},\Varid{z}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{invConvTuplo}\mathbin{::}(\Conid{Integer},\Conid{Integer},\Conid{Integer},\Conid{Integer})\to ((\Conid{Integer},\Conid{Integer}),(\Conid{Integer},\Conid{Integer})){}\<[E]%
\\
\>[B]{}\Varid{invConvTuplo}\;(\Varid{x},\Varid{y},\Varid{w},\Varid{z})\mathrel{=}((\Varid{x},\Varid{y}),(\Varid{w},\Varid{z})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{outFTree}\;(\Conid{Unit}\;\Varid{x}){}\<[23]%
\>[23]{}\mathrel{=}i_1\;\Varid{x}{}\<[E]%
\\
\>[B]{}\Varid{outFTree}\;(\Conid{Comp}\;\Varid{x}\;\Varid{e}\;\Varid{d})\mathrel{=}i_2\;(\Varid{x},(\Varid{e},\Varid{d})){}\<[E]%
\\
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{generatePTree}\;\Varid{i}\mathrel{=}\Varid{anaFTree}\;\Varid{constroiAna}\;(\Varid{i},\mathrm{2.0}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{11}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{constroiAna}\mathbin{::}(\Conid{Int},\Conid{Square})\to \Conid{Square}+(\Conid{Square},((\Conid{Int},\Conid{Square}),(\Conid{Int},\Conid{Square}))){}\<[E]%
\\
\>[B]{}\Varid{constroiAna}\;(\mathrm{0},\Varid{x})\mathrel{=}i_1\;(\Varid{x}){}\<[E]%
\\
\>[B]{}\Varid{constroiAna}\;(\Varid{i},\Varid{x})\mathrel{=}i_2\;(\Varid{x},((\Varid{ant},(\Varid{sqrt}\;(\mathrm{2})\mathbin{/}\mathrm{2})\mathbin{*}\Varid{x}),(\Varid{ant},(\Varid{sqrt}\;(\mathrm{2})\mathbin{/}\mathrm{2})\mathbin{*}\Varid{x}))){}\<[E]%
\\
\>[B]{}\hsindent{11}{}\<[11]%
\>[11]{}\mathbf{where}\;\Varid{ant}\mathrel{=}\Varid{pred}\;\Varid{i}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{uncurryComp}\mathbin{::}(\Varid{a}\to \Varid{b}\to \Varid{c}\to \Varid{d})\to (\Varid{a},(\Varid{b},\Varid{c}))\to \Varid{d}{}\<[E]%
\\
\>[B]{}\Varid{uncurryComp}\;\Varid{f}\;(\Varid{x},(\Varid{y},\Varid{z}))\mathrel{=}\Varid{f}\;\Varid{x}\;\Varid{y}\;\Varid{z}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{curryComp}\mathbin{::}((\Varid{a},(\Varid{b},\Varid{c}))\to \Varid{d})\to \Varid{a}\to \Varid{b}\to \Varid{c}\to \Varid{d}{}\<[E]%
\\
\>[B]{}\Varid{curryComp}\;\Varid{f}\;\Varid{x}\;\Varid{y}\;\Varid{z}\mathrel{=}\Varid{f}\;(\Varid{x},(\Varid{y},\Varid{z})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
&
    \ensuremath{\Conid{Bag}\;([\mskip1.5mu (\Varid{a},\Conid{Int})\mskip1.5mu])}
            \ar[d]^{\ensuremath{\Varid{bagValor}}}
\\
...
\column{10}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mu \mathrel{=}\mathit B{}\<[10]%
\>[10]{}\comp \Varid{bagValor}\comp (\mathsf{fmap}\;\Varid{unB}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{bagValor}\mathbin{::}\Conid{Bag}\;[\mskip1.5mu (\Varid{a},\Conid{Int})\mskip1.5mu]\to [\mskip1.5mu (\Varid{a},\Conid{Int})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{bagValor}\mathrel{=}\Varid{concat}\comp (\map \;\Varid{novoValor})\comp \Varid{unB}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{novoValor}\mathbin{::}([\mskip1.5mu (\Varid{a},\Conid{Int})\mskip1.5mu],\Conid{Int})\to [\mskip1.5mu (\Varid{a},\Conid{Int})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{novoValor}\;(\Varid{x},\Varid{y})\mathrel{=}\map \;(\Varid{id}\times(\mathbin{*}\Varid{y}))\;\Varid{x}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{dist}\;\Varid{b}\mathrel{=}\Varid{prob}\;\Varid{b}\;(\Varid{nBags}\;\Varid{b}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{prob}\mathbin{::}\Conid{Bag}\;\Varid{a}\to \Conid{Int}\to \fun{Dist}\;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{prob}\;(\mathit B\;\Varid{t})\;\Varid{i}\mathrel{=}\Conid{D}\;(\Varid{intToProb}\;\Varid{t}\;\Varid{i}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{intToProb}\mathbin{::}[\mskip1.5mu (\Varid{a},\Conid{Int})\mskip1.5mu]\to \Conid{Int}\to [\mskip1.5mu (\Varid{a},\Conid{ProbRep})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{intToProb}\;[\mskip1.5mu \mskip1.5mu]\;\anonymous \mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{intToProb}\;((\Varid{a},\Varid{n})\mathbin{:}\Varid{t})\;\Varid{i}\mathrel{=}\Varid{cons}\;((\Varid{a},(\Varid{fromIntegral}\;\Varid{n})\mathbin{/}(\Varid{fromIntegral}\;\Varid{i})),\Varid{intToProb}\;\Varid{t}\;\Varid{i}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{nBags}\mathbin{::}\Conid{Bag}\;\Varid{a}\to \Conid{Int}{}\<[E]%
\\
\>[B]{}\Varid{nBags}\;(\mathit B\;[\mskip1.5mu \mskip1.5mu])\mathrel{=}\mathrm{0}{}\<[E]%
\\
\>[B]{}\Varid{nBags}\;(\mathit B\;((\Varid{a},\Varid{i})\mathbin{:}\Varid{t}))\mathrel{=}\Varid{i}\mathbin{+}\Varid{nBags}\;(\mathit B\;\Varid{t}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
