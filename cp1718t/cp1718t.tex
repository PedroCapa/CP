...
\begin{eqnarray*}
\xymatrix@C=2cm{
  \ensuremath{\N_0\times\Conid{Square}}
      \ar[u]_-{\ensuremath{\Varid{constroiAna}}}
      \ar[r]_-{\ensuremath{\Varid{out}\times\Varid{id}}}
&
  \ensuremath{\mathrm{1}\mathbin{+}\N_0\times\N_0}
      \ar[r]_-{\ensuremath{\Varid{constroiAna}}}
&
  \ensuremath{\Conid{Square}\mathbin{+}\Conid{Square}\times(\N_0\times\Conid{Square})\lambda \Varid{ar}\;[\mskip1.5mu \Varid{llu}\mskip1.5mu]\mathbin{\char94 -}\{\mskip1.5mu }id + id >< constroiAna}
\\
  \ensuremath{\Conid{PTree}}
&
  \ensuremath{\Conid{Square}\mathbin{+}\Conid{Square}\times(\Conid{PTree}\times\Conid{PTree})}
      \ar[l]_-{\ensuremath{\Varid{inFTree}}}
}
\end{eqnarray*}
